...
- A file with no extension will not be added to the manifest (e.g., LICENSE, README) if imported into SODA.

## v 19.0.1 - 2026-08-28

## Bug fixes:

- Pennsieve Agent version alignment on latest causes error where pennsieve login page cannot continue.
...
- Release made to incorporate file-rename bug fix in pysodafair.
