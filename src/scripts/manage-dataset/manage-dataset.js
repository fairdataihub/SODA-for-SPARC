      ...
      (error, res) => {
        if (error) {
          ...
          ipcRenderer.send(
            "track-event",
            "Error",
            "Manage Dataset - Upload banner image - Get banner image",
            defaultBfDatasetId
          );
      ...
      (error, res) => {
        if (error) {
          ...
          ipcRenderer.send(
            "track-event",
            "Error",
            "Manage Dataset - Assign License Get banner image",
            defaultBfDatasetId
          );
        } else {
          ...
          (error, res) => {
            if (error) {
              ...
              ipcRenderer.send(
                "track-event",
                "Success",
                `Upload Local Dataset - ${selectedbfdataset} - Number of Folders`,
                num_of_folders
              );
              ...
              ipcRenderer.send(
                "track-event",
                "Success",
                `Upload Local Dataset - ${selectedbfdataset} - Number of Files`,
                num_of_files
              );
