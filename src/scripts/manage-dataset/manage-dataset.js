    ...
    (error, res) => {
      if (error) {
        ...
        ipcRenderer.send(
          "track-event",
          "Success",
          `Upload Local Dataset - ${selectedBfDatasetId} - size`,
          totalFileSize
        );
          ...
          (error, res) => {
            if (error) {
              ...
              ipcRenderer.send(
                "track-event",
                "Success",
                `Upload Local Dataset - ${selectedBfDatasetId} - Number of Folders`,
                num_of_folders
              );
              ...
              ipcRenderer.send(
                "track-event",
                "Success",
                `Upload Local Dataset - ${selectedBfDatasetId} - Number of Files`,
                num_of_files
              );
