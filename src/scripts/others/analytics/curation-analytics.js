...
const { determineDatasetLocation } = require("./scripts/others/analytics/utils")
...
const logCurationErrorsToAnalytics = async (main_total_generate_dataset_size, uploadedFiles,  uploadedFilesSize) => {
    ...
    if (datasetLocation !== "Pennsieve") {
        let filesGeneratedForDataset = await getLocallyGeneratedFileCount("TODO: Generation location")
...
module.exports = { logCurationErrorsToAnalytics, logCurationSuccessToAnalytics }