...
async function connectProtocol(type) {
  // build/dev mode agnostic path to protocol-info png file
  var protocolInfoPath = path.join(__dirname, "..", "docs", "documentation", "Prepare-metadata", "subjects", "protocol-info.png");
