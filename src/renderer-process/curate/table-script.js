...
function edit_row_org(no) {
  ...
  description.innerHTML =
    "<input type='text' id='description_text_org" +
    no +
    "' value='" +
    description_data +
    "'>";
...
function save_row_org(no) {
  var description_val = document.getElementById("description_text_org" + no)
    .value;

  document.getElementById(
    "description_row_org" + no
  ).innerHTML = description_val;
...
document
  .getElementById("table-organized")
