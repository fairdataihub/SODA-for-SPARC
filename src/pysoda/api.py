...
class SodaApi(object):
    ...
    def api_import_bf_sub_sam(self, filetype, ui_field, selected_bfaccount, selected_bfdataset):
        return import_bf_sub_sam(filetype, ui_field, selected_bfaccount, selected_bfdataset)
