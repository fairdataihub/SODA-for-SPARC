...
class SodaApi(object):
    ...
    def api_save_submission_file(self, upload_boolean, bfaccount, bfdataset, filepath, val_arr):
        return save_submission_file(upload_boolean, filepath, val_arr)

    ### Save Description file
    def api_save_ds_description_file(
        self, upload_boolean, bfaccount, bfdataset, filepath, val_arr1, val_arr_study, val_arr2, val_arr3
    ):
        return save_ds_description_file(
            upload_boolean, bfaccount, bfdataset, filepath, val_arr1, val_arr_study, val_arr2, val_arr3
        )

    ### Save subjects file
    def api_save_subjects_file(self, upload_boolean, bfaccount, bfdataset, filepath, datastructure):
        return save_subjects_file(upload_boolean, bfaccount, bfdataset, filepath, datastructure)
    ...
    ### Save samples file
    def api_save_samples_file(self, upload_boolean, bfaccount, bfdataset, filepath, datastructure):
        return save_samples_file(upload_boolean, bfaccount, bfdataset, filepath, datastructure)
