...
const checkForAnnouncements = async (state) => {
  const url = `https://raw.githubusercontent.com/fairdataihub/SODA-for-SPARC/main/src/renderer/src/scripts/meta/announcements.json?timestamp=${new Date().getTime()}`;
