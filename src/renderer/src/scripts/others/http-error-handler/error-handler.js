...
const userErrorMessage = (error, includeContactAddendum = true) => {
  let errorMessage = "";
  let contactSODATeamAddendum = `If this issue continues, please reach out to us using the Conact Us page accessible from the landing page. For help navigating to the landing page see our documentation <a href="https://docs.sodaforsparc.io/docs/contact-us" target="_blank">here</a>.`;
