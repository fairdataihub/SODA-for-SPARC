    ...
    <tr>
      <td class="middle aligned sample-id-cell">
        <div class="space-between w-100" style="align-items: center">
          ...
          />
          <i class="far fa-check-circle fa-solid" style="cursor: pointer; margin-left: 15px; color: var(--color-primary); font-size: 1.24rem;" onclick="window.confirmEnter(this)"></i>
        </div>
      </td>
  ...
  if (deleted) {
    ...
    <tr class="fromPennsieve" data-entity-type=${entityType}>
      ...
      <td class="middle aligned text-center remove-left-border" style="width: 20px">
        ...
        <button type="button" class="btn btn-sm" style="display: inline-block;color: white; background-color: var(--color-primary); border-color: var(--color-primary);" onclick="window.removePennsievePermission($(this))">Restore</button>
      </td>
    </tr>
  `;
  } else {
    return `
      <tr class="fromPennsieve" data-entity-type=${entityType}>
        ...
        <td class="middle aligned text-center remove-left-border" style="width: 20px">
          ...
          <button type="button" class="btn btn-sm" style="display: none;color: white; background-color: var(--color-primary); border-color: var(--color-primary);" onclick="window.removePennsievePermission($(this))">Restore</button>
        </td>
      </tr>
    `;
  }
