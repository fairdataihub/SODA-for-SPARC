...
export const checkboxCardSlice = (set) => ({
  cardData: {
    ...
    "categorize-entity-bucketing-data-yes": {
      ...
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["categorize-entity-bucketing-data-no"],
      nextElementID: "guided-section-entity-bucketing-data-categorization-yes-message",
      checked: false,
      configValue: "categorize-entity-bucketing-data",
      configValueState: "yes",
    },
    "categorize-entity-bucketing-data-no": {
      ...
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["categorize-entity-bucketing-data-yes"],
      nextElementID: "guided-section-entity-bucketing-data-categorization-no-message",
      checked: false,
      configValue: "categorize-entity-bucketing-data",
      configValueState: "no",
    },
    ...
    "ffm-confirm-pennsieve-account-button": {
      ...
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["ffm-button-switch-account"],
      nextElementID: "ffm-section-select-organization",
      checked: false,
      configValue: null,
      configValueState: null,
    },
    "ffm-button-switch-account": {
      simpleButtonType: "Negative",
      title: "No, connect another account",
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["ffm-confirm-pennsieve-account-button"],
      nextElementID: null,
      checked: false,
      configValue: null,
      configValueState: null,
    ...
    "ffm-confirm-pennsieve-organization-button": {
      simpleButtonType: "Positive",
      title: "Yes, this is the organization",
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["ffm-button-switch-organization"],
      checked: false,
      configValue: null,
      configValueState: null,
    ...
    "ffm-button-switch-organization": {
      ...
      description: null,
      Icon: null,
      mutuallyExclusiveWithCards: ["ffm-confirm-pennsieve-organization-button"],
      nextElementID: null,
      checked: false,
      configValue: null,
      configValueState: null,
