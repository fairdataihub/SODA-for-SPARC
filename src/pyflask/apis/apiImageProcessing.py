...
class GetBiolucidaImageId(Resource):
    ...
    request_model = {
        ...
        'collection_id': fields.String(required=True, description="The ID of the collection the image is in"),
    }
    response_model = {
        'image_id': fields.String(required=True, description="The ID of the image"),
    }

    parser = reqparse.RequestParser(bundle_errors=True)
    parser.add_argument('image_name', type=str, required=True, help="The name of the image to get the ID for")
    parser.add_argument('collection_id', type=str, required=True, help="The ID of the collection the image is in")
